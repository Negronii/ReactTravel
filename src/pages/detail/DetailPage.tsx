...
import { getProductDetails } from "../../redux/productDetails/slice";
    ...
    return (
        <>
            ...
            <div className={styles['page-content']}>
                {/* Product description and date selector */}
                ...
                <Anchor className={styles['product-detail-anchor']}>
                    <Menu mode={"horizontal"}>
                        ...
                        <Menu.Item key={"4"}>
                            <Anchor.Link href={"#notes"} title={"Notes"}/>
                        </Menu.Item>
                        <Menu.Item key={"5"}>
                ...
                <div id="fees" className={styles['product-detail-container']}>
                    <Divider orientation="center">
                        <Typography.Title level={3}>Product cost</Typography.Title>
                    </Divider>
